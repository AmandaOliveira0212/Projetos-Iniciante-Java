...
public class TelaValores extends javax.swing.JFrame {
    ...
    private void btnDividirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDividirActionPerformed
        int n = Integer.parseInt(txtNum.getText()); // conteudo da caixa de texto
        int d = Integer.parseInt(txtDen.getText());
        float div = n / d; // divisao
        float res = n % d; //resto da vidisao
        lblDiv.setText(Float.toString(div)); //mostrar a variavel de divisão
        lblResto.setText(Float.toString(res)); // convertendo tudo para String
